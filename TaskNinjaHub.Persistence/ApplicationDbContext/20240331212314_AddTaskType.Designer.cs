...
namespace TaskNinjaHub.Persistence.ApplicationDbContext
{
    ...
    [Migration("20240331212314_AddTaskType")]
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.TaskTypes.Domain.CatalogTaskType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(488),
                            Name = "Bug"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(559),
                            Name = "Feature"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(590),
                            Name = "Epic"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(606),
                            Name = "Testing"
                        },
                        new
                        {
                            Id = 5,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(632),
                            Name = "Task"
                        },
                        new
                        {
                            Id = 6,
                            DateCreated = new DateTime(2024, 4, 1, 0, 23, 13, 594, DateTimeKind.Local).AddTicks(646),
                            Name = "Requirement"
                        });
                });
