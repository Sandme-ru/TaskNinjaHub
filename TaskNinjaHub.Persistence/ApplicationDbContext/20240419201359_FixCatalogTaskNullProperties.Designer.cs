...
namespace TaskNinjaHub.Persistence.ApplicationDbContext
{
    ...
    [Migration("20240419201359_FixCatalogTaskNullProperties")]
    partial class FixCatalogTaskNullProperties
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.Authors.Domain.Author", b =>
                {
                    ...
                    b.Property<int?>("LocalizationType")
                        .HasColumnType("integer")
                        .HasColumnName("localization_type");
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.RelatedTasks.Domain.RelatedTask", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<int>("SubordinateTaskId")
                        .HasColumnType("integer")
                        .HasColumnName("subordinate_task_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_related_tasks");

                    b.HasIndex("MainTaskId")
                        .HasDatabaseName("ix_related_tasks_main_task_id");

                    b.HasIndex("SubordinateTaskId")
                        .HasDatabaseName("ix_related_tasks_subordinate_task_id");

                    b.ToTable("related_tasks", (string)null);
                });
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.TaskTypes.Domain.CatalogTaskType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5318),
                            Name = "Bug"
                        },
                        new
                        {
                            Id = 2,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5347),
                            Name = "Feature"
                        },
                        new
                        {
                            Id = 3,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5361),
                            Name = "Epic"
                        },
                        new
                        {
                            Id = 4,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5373),
                            Name = "Testing"
                        },
                        new
                        {
                            Id = 5,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5386),
                            Name = "Task"
                        },
                        new
                        {
                            Id = 6,
                            DateCreated = new DateTime(2024, 4, 19, 23, 13, 58, 612, DateTimeKind.Local).AddTicks(5400),
                            Name = "Requirement"
                        });
                });
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.Tasks.Domain.CatalogTask", b =>
                {
                    ...
                    b.HasIndex("TaskTypeId")
                        .HasDatabaseName("ix_catalog_tasks_task_type_id");
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.RelatedTasks.Domain.RelatedTask", b =>
                {
                    b.HasOne("TaskNinjaHub.Application.Entities.Tasks.Domain.CatalogTask", "MainTask")
                        .WithMany()
                        .HasForeignKey("MainTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_related_tasks_catalog_tasks_main_task_id");

                    b.HasOne("TaskNinjaHub.Application.Entities.Tasks.Domain.CatalogTask", "SubordinateTask")
                        .WithMany()
                        .HasForeignKey("SubordinateTaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_related_tasks_catalog_tasks_subordinate_task_id");

                    b.Navigation("MainTask");

                    b.Navigation("SubordinateTask");
                });
            ...
            modelBuilder.Entity("TaskNinjaHub.Application.Entities.Tasks.Domain.CatalogTask", b =>
                {
                    ...
                    b.HasOne("TaskNinjaHub.Application.Entities.TaskTypes.Domain.CatalogTaskType", "TaskType")
                        .WithMany()
                        .HasForeignKey("TaskTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_catalog_tasks_task_types_task_type_id");
